...
import backtype.storm.dweb.DWEBSpout;
...
import backtype.storm.dweb.URICheck;
...
public class DWEBTopologyBuilder {

	String _application;
    Map<String, List<Component>> _routers = new HashMap<String, List<Component>>();
    
    
    public DWEBTopologyBuilder(String application) {
        _application = application;
    }
        
    public LinearDWEBInputDeclarer addBolt(String router, IBatchBolt bolt, Number parallelism) {
        return addBolt(router,new BatchBoltExecutor(bolt), parallelism);
    }
    
    public LinearDWEBInputDeclarer addBolt(String router,IBatchBolt bolt) {
        return addBolt(router,bolt, 1);
    }
    
    @Deprecated
    public LinearDWEBInputDeclarer addBolt(String router, IRichBolt bolt, Number parallelism) {
    ...
    @Deprecated
    public LinearDWEBInputDeclarer addBolt(String router,IRichBolt bolt) {
        return addBolt(router, bolt, null);
    }
    
    public LinearDWEBInputDeclarer addBolt(String router, IBasicBolt bolt, Number parallelism) {
        return addBolt(router,new BasicBoltExecutor(bolt), parallelism);
    }

    public LinearDWEBInputDeclarer addBolt(String router, IBasicBolt bolt) {
        return addBolt(router,bolt, null);
    }
